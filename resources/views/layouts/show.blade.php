...
<head>
    ...
    {!! Html::style(asset('css/private.css')) !!}
    {!! Html::style(asset('css/dataTables.min.css')) !!}
    {!! Html::style(asset('css/tableStyle.min.css')) !!}
        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Registro">
                ...
                <ul class="sidenav-second-level collapse" id="collapseComponents">
                    @if(Auth::user()->hasRole('Guest') ||Auth::user()->hasRole('Admin'))
                    <li>
                        <a href="{{ asset('/referencias') }}">Referencias</a>
                    </li>
                    @endif
                    @if(Auth::user()->hasRole('Admin'))
                    <li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <div class="input-group">
                    ...
                    <a class="nav-link" href="{{ asset('/usuario/editar/'.auth()->user()->id.'') }}">
...
<div class="content-wrapper">
    <div class="row">
        <div class="col">
            <div class="contaier">
                <div class="row containerr-show">
                    <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 show-header">
                       <img src="https://www.zadar.travel/images/thumb/DENTEX_LOGO_2_1457507970.jpg" class="img-fluid" alt="Responsive image" style="width: 10em">
                    </div>
                    <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10">
                        <h6><strong>Dr. Jose Rafael Mora Solera</strong></h6>
                        <h6><strong>MsC. Endodoncia(Tratamiento Nervio)</strong></h6>
                        <h6>Frente a la Entrada de San Antonio. Ciudad Quesada. San Carlos</h6>
                        <h6>Tel: 2460-1169  <i class="fa fa-whatsapp"></i>8904-7253 <i class="fa fa-envelope-o"></i>endomora@gmail.com</h6>
                    </div>
                </div>
            </div>
        </div>
...
{!! Html::script(asset('components/bootstrap/js/bootstrap.bundle.min.js')) !!}
{!! Html::script(asset('components/jquery-easing/jquery.easing.min.js')) !!}
{!! Html::script(asset('js/sb-admin.min.js')) !!}
{!! Html::script(asset('components/jquery.validate.min.js')) !!}
{!! Html::script(asset('js/private.js')) !!}
{!! Html::script(asset('js/dataTable.min.js')) !!}
{!! Html::script(asset('js/dataTableBootstrap.min.js')) !!}
</body>
</html>
