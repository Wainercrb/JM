@extends('layouts.private') @section('title') NUEVO POST @endsection @section('datails') MUESTRA TU TRABAJO A TODOS @endsection
@section('action') NUEVO POST @endsection @section('styles') @endsection @section('javascript')
<script>
...
<div class="container">
    <form action="{{ asset('post\guardar') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <textarea class="form-control" rows="5" name="details" placeholder="¿Que estas pensando?"></textarea>
            </div>
