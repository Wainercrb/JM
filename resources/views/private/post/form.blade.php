...
<div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
        {!!Form::label('details', 'Detalles:')!!} {!!Form::textarea('details', old('details'), ['id' => 'details', 'class' => 'form-control',
                        'required' => true, 'rows' => 5, 'placeholder' => '¿Que estas pensando?'])!!}
    </div>
        ...
        <div class="tab-content">
                      ...
                      @endif
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="btn-group container-input-file btn-group-files">
                                <label id="labelInputFile" onclick="callInputFile()" class="btn">
                                    <i class="fa fa-file-image-o"></i>
                                </label>
                                <input id="files" class="files" type="file" name="file[]" multiple="multiple"
                                        accept="image/x-png,image/gif,image/jpeg,image/PNG" />
                                <button type="button" class="btn" id="clearFiles" onclick="removeFiles()">
            ...
            <div role="tabpanel" class="tab-pane fade" id="video">
                <div class="container container-tab">
                    <div class="row row-tab">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <button class="btn btn-new-row" type="button" onclick="addRowTableVideo()">Nuevo</button>
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tableVideo">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="table-warning">url</th>
                                            <th class="text-center table-warning">Eliminar</th>
                                                    ...
                                                    <tr>
                                                        <td class="table-warning">
                                                            <input type="text" class="form-control" readonly="true"
                                                                    value="https://www.youtube.com/watch?v={{$item->src }}">
                                                        </td>
                                                        <td class="text-center table-warning">
                                                            <input type="checkbox" name="mediaVideo[]"  value="{{ $item->id }}">
                                                        </td>
